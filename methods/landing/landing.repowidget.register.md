...
|| **lang**
[`string`](../data-types.md) | Массив языковых фраз, использующихся в конструкциях `` ||
|| **handler***
...
- JS
    ...
    const content = `
        <div class="my-app-w-container">
            ...
            <h3>Description: not_var</h3>
            
            <div v-for="(value) in persons">
                <p>
                    <span class="w-name">not_var</span>:
                    <span class="w-age">not_var</span>
                </p>
            </div>
